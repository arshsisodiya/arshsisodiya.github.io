...
const About = () => {
  ...
  const skills = ['Python', 'Javascript', 'Java', 'Linux', 'Adobe Premier Pro', 'Docker'];
  const service = ['Heroku', 'Netlify', 'Azure', 'Google Cloud'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! My name is Bhagchand Meena aka Arsh Sisodiya and I enjoy creating things that
              live on the internet. I have a background in Science-Maths from high school and
            ...
            <p>
              I’ve developed{' '}
              <a href="https://github.com/arshsisodiya/helios-mirror/">
          ...
          <div>
            <p></p>
            <p>Here are a few cloud services I have used:</p>
          </div>

          <ul className="skills-list">
            {service && service.map((skill, i) => <li key={i}>{skill}</li>)}
          </ul>
        </StyledText>
